...
def save_predictions_to_sql(conn_str: str, predictions_df: pd.DataFrame, run_id: str):
    ...
    for i in range(0, len(predictions_df), chunk_size):
        ...
        chunk.to_sql('dqn_daily_predictions_Single', engine, if_exists='append', index=False)
    ...
    summary.to_sql('dqn_prediction_summary_Single', engine, if_exists='append', index=False)
